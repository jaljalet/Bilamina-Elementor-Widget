...
final class Bilamina_Elementor_Widget {
    ...
    */
    public function i18n() {
       load_plugin_textdomain( 'bilamina-elementor-widget', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' );
    }
    ...
    */
    public function admin_notice_missing_main_plugin() {
        ...
        $message = sprintf(
            esc_html__( '"%1$s" requires "%2$s" to be installed and activated', 'bilamina-elementor-widget' ),
            '<strong>'.esc_html__( 'Bilamina Elementor Widget', 'bilamina-elementor-widget' ).'</strong>',
            '<strong>'.esc_html__( 'Elementor', 'bilamina-elementor-widget' ).'</strong>'
        );
    ...
    */
    public function admin_notice_minimum_elementor_version() {
        if( isset( $_GET[ 'activate' ] ) ) unset( $_GET[ 'activate' ] );
        $message = sprintf(
            esc_html__( '"%1$s" requires "%2$s" version %3$s or greater', 'bilamina-elementor-widget' ),
            '<strong>'.esc_html__( 'Bilamina Elementor Widget', 'bilamina-elementor-widget' ).'</strong>',
            '<strong>'.esc_html__( 'Elementor', 'bilamina-elementor-widget' ).'</strong>',
    ...
    */
    public function admin_notice_minimum_php_version() {
        ...
        $message = sprintf(
            esc_html__( '"%1$s" requires "%2$s" version %3$s or greater', 'bilamina-elementor-widget' ),
            '<strong>'.esc_html__( 'Bilamina Elementor Widget', 'bilamina-elementor-widget' ).'</strong>',
            '<strong>'.esc_html__( 'PHP', 'bilamina-elementor-widget' ).'</strong>',
